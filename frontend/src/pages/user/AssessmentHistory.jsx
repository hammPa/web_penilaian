  ...
  return (
    <div className="min-h-full bg-[#F3F4F7] -m-6 p-6 md:-m-8 md:p-8">
      ...
      {assessments.length === 0 ? (
        ...
        <>
          {/* TAMPILAN MOBILE: Berubah jadi tumpukan kartu yang rapi */}
                ...
                <div key={item.id} className="bg-white rounded-xl p-5 shadow-sm border border-gray-100 flex flex-col justify-between space-y-4">
                  ...
                  <div className="pt-3 border-t border-slate-100 flex justify-between items-center">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center justify-center rounded-lg bg-[#C8933E]/10 px-4 py-2 text-sm font-medium text-[#C8933E] hover:bg-[#C8933E]/20 transition-colors"
                    >
                      Lihat Detail
                    </Link>
                  </div>
          ...
          {/* TAMPILAN DESKTOP: Tetap menggunakan tabel Grid asli */}
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-100 bg-slate-50/60">
                  ...
                  <th className="text-left font-medium text-[11px] uppercase tracking-[0.1em] text-slate-400 px-6 py-3">Persentase</th>
                  <th className="text-right font-medium text-[11px] uppercase tracking-[0.1em] text-slate-400 px-6 py-3">Detail</th>
                </tr>
              </thead>
                  ...
                  return (
                    <tr key={item.id} className="hover:bg-slate-50/70 transition-colors">
                      ...
                      <td className="px-6 py-4 text-right">
                        <Link to={`/assessments/${item.id}`} className="text-[#C8933E] hover:text-[#a97a30] font-medium">
                          Lihat →
                        </Link>
                      </td>
                    </tr>
